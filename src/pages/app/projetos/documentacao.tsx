...
import { documentacao } from "@/constants/index";
...
export function Documentacao() {
  ...
  const [filteredProjects, setFilteredProjects] = useState(() =>
    documentacao.filter((art) => art.status.includes("todos")),
  );

  function handleChangeState(status: "todos") {
    const filtered = documentacao.filter((cert) =>
